                  ...
                  <div className="flex-1 overflow-auto p-4">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        {task.testCases.slice(0, Math.min(3, task.testCases.length)).map((_, index) => (
                          <Button
                            key={index}
                        ...
                        {task.testCases.length > 3 && (
                          <div className="text-sm text-muted-foreground ml-2">
                            +{task.testCases.length - 3} скрытых тестов
                          </div>
                        )}
                      </div>
                      ...
                      {(() => {
                        ...
                        if (selectedTest >= Math.min(3, task.testCases.length)) {
                          setSelectedTest(0);
                          return null;
                        }
                        return (

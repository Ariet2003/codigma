...
import { Shield, Lock, Eye, UserCheck, Server, Trash2, Clock, FileCheck, HelpCircle, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="container py-8 md:py-12">
      <div className="max-w-3xl mx-auto space-y-8">
        <Button
          variant="ghost"
          className="group mb-4 -ml-4 text-muted-foreground hover:text-foreground"
          onClick={() => router.back()}
        >

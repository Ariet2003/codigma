          ...
          {steps.map((step: any, index: number) => (
            ...
            >
              <div className="flex gap-3 items-center">
                <div className="flex py-[2px] px-4 rounded-3xl bg-[#4E7AFF] text-white animate-pulse-slow">
                  Шаг {index + 1}
                </div>
                <div className="bg-[#4E7AFF]/10 p-2 rounded-lg">
                  <img src={step.icon} alt={step.heading} className="w-6 h-6" />
                </div>
